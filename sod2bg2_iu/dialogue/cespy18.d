...
EXTEND_BOTTOM BOTSMITH 4
  IF ~PartyHasItem("dtkplat1")~ THEN GOTO reddragCespy // Chromatic Crimson Dragon Plate (blue, white, shadow, silver, green, black, or red)
END
...
SAY @1078
 IF ~PartyGoldLT(20000)~ THEN REPLY #66908 GOTO 10
 IF ~PartyGoldGT(19999)~ THEN REPLY #66909 DO ~SetGlobal("DTKItemsCespy","GLOBAL",83)
                                	        TakePartyGold(20000)
                                 		TakePartyItemNum("dtkplat1",1)
...
SAY @1078
 IF ~PartyGoldLT(20000)~ THEN REPLY #66908 GOTO 10
 IF ~PartyGoldGT(19999)~ THEN REPLY #66909 DO ~SetGlobal("DTKItemsCespy","GLOBAL",85)
                                	        TakePartyGold(20000)
                                 		TakePartyItemNum("dtkplat1",1)
