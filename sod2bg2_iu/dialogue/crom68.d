...
IF ~PartyHasItem("dtklea3")~ THEN GOTO PartyHasRedDragLeather	//Chromatic Crimson/Carmine Viridian/Scarlet Viridescent Dragonscale
END

APPEND WSMITH01

IF ~~ THEN BEGIN PartyHasRedDragLeather
SAY @234
 IF ~OR(7)
     PartyHasItem("scaleb")
...
SAY @74
 ...
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",100)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",99)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtklea3",1)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",98)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtklea3",1)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",95)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtklea3",1)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",96)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtklea3",1)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",94)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtklea3",1)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",97)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtklea3",1)
