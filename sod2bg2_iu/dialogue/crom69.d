...
IF ~PartyHasItem("dtkplt3")~ THEN GOTO PartyHasShadowDragPlate	//Chromatic Shadow/Viridescent Shadow/Umbral Viridescent Dragon Plate
END

APPEND WSMITH01

IF ~~ THEN BEGIN PartyHasShadowDragPlate
SAY @235
 IF ~OR(7)
     PartyHasItem("scaler")
...
SAY @74
 ...
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",91)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",93)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtkplt3",1)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",92)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtkplt3",1)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",88)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtkplt3",1)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",90)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtkplt3",1)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",89)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtkplt3",1)
...
SAY @74
 IF ~PartyGoldLT(20000)~ THEN REPLY #66662 GOTO MovingRightAlong
 IF ~PartyGoldGT(19999)~ THEN DO ~SetGlobal("DTKItems","ar0334",117)
                                 SetGlobal("ForgeStuff","GLOBAL",1)
                                 TakePartyGold(20000)
                                 TakePartyItemNum("dtkplt3",1)
